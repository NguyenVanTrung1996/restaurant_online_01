            ...
            <div class="row " style="margin: 20px">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-5">
                        <div style="padding-left: 20px">
                            ...
                            <p style="margin-bottom: 15px" >{{$sanpham->discrible}} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi aperiam delectus ea esse facere labore laudantium libero nihil tempore voluptatibus. </p>
                            <strong>Nhãn Hiệu :</strong><br>
                            <strong>Tình Trạng :</strong>
                                <?php;?>
                                @if($sanpham->status>0)
                            <!--Con hang hay het hang-->Còn hàng
                                @else
                                    Hết hàng
                                    @endif
            ...
            <div style="padding: 20px;margin-bottom: 50px">
                ...
                <div class="tab-content">
                    <section id="idTab1" class="tab-pane  active text-center">
                        <h3>{{$sanpham->name}}</h3>
                        <img style="width: 400px;height: 300px" src="http://localhost:8000/img/{{$sanpham->avatar}}" style="width: 400px" alt="hinhanh">
